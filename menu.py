...
SCREEN = pg.display.set_mode((640+200, 640))
...
def busqueda_informada():
    while True:
        ...
        OPTIONS_BACK = Button(image=None, pos=(420, 560), 
...
def busqueda_no_informada():
    while True:
        ...
        AMPLITUD = Button(image=None, pos=(420, 160), 
        ...
        COSTO_UNIFORME = Button(image=None, pos=(420, 260), 
        ...
        PROFUNDIDAD_EVITANDO_CICLOS = Button(image=None, pos=(420, 360), 
