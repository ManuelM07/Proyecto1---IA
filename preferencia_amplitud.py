...
def crear_hijos(nodo_padre):
    ...
    for op in operadores:
        ...
        if (op == "arriba" and arriba != -1 and arriba != 1): #verifica que se puede mover (no sale de la matriz y no hay un muro).
            if (nodo_padre.operador == "abajo" and (nodo_padre.nave != nave_hijo) or # verifica que se puede devolver
            ...
            if (nodo_padre.operador == "arriba" and (nodo_padre.nave != nave_hijo) or # se verifica que se puede devolver
            ...
            if (nodo_padre.operador == "derecha" and (nodo_padre.nave != nave_hijo) or # se verifica que se puede devolver
            ...
            if (nodo_padre.operador == "izquierda" and (nodo_padre.nave != nave_hijo) or # se verifica que se puede devolver
